...
#              100     10       1      200
# Model:   1-100,201-400,501-501,602-701,802-811
...
test_that( 'Test that genomicToModelCoordinates >= last +exon are ok.', {
...
test_that( 'Test that genomicToModelCoordinates in +gaps are ok.', {
   # first gap ( = gapWidth)
...
test_that( 'Test that genomicToModelCoordinates <= first -exon are ok.', {
...
test_that( 'genomicToModelCoordinates; extremes ok, +model?', {
