...
terminated by newlines. At least one column, "sample", must contain the sample
names and another, "exonExpressionFile" the path to the exon expression files
for those samples. Other columns are ignored.
