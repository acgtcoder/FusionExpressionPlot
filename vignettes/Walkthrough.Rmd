...
terminated by newlines. At least one column (normally the first) must contain 
the sample names and another the path to the exon expression files for those 
samples. Usually these columnas are called "sample" and "exonExpressionFile".
...
(2) Getting list of quantification files: [TODO - replace with DCC info...]
